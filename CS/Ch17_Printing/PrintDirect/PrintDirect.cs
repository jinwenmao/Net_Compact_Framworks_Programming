// PrintDirect.cs - Main form for PrintDirect program, which
// demonstrates printing by sending output directly to a port
// with no intermediate rendering.
//
...
namespace PrintDirect
{
   ...
   public class FormMain : System.Windows.Forms.Form
   {
      ...
      private void InitializeComponent()
      {
         ...
         // tboxInput
         // 
         this.tboxInput.ContextMenu = this.cmenuMain;
         ...
         this.mitemEditCut.Click += new System.EventHandler(this.mitemEditCut_Click);
         // 
         // mitemEditCopy
         // 
         this.mitemEditCopy.Text = "Copy";
         this.mitemEditCopy.Click += new System.EventHandler(this.mitemEditCopy_Click);
         // 
         // mitemEditPaste
         // 
         this.mitemEditPaste.Text = "Paste";
         this.mitemEditPaste.Click += new System.EventHandler(this.mitemEditPaste_Click);
         // 
         // menuItem7
         // 
         this.menuItem7.Text = "-";
         ...
         this.mitemEditUndo.Click += new System.EventHandler(this.mitemEditUndo_Click);
         // 
         // menuItem8
         // 
         this.menuItem8.Text = "-";
      ...
      private void mitemFilePrint_Click(object sender, EventArgs e)
      {
         ...
         try
         {
            ...
            if (iErr != 0)
            {
               ...
               string strPort;
               strPort = PrintSetupDlg.QueryOutputPort(ref psd);

               // Check whether port is an IP address.
               if (PrintJob_Socket.IsIPAddress(strPort))
               {
