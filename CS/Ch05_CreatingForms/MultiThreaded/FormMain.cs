...
namespace MultiThreaded
{
   ...
   public class FormMain : System.Windows.Forms.Form
   {
      ...
      private void cmdTemp_Click(object sender, 
                                 System.EventArgs e)
      {
         Thread thrdTemperature;
         thrdTemperature = 
            new Thread(new ThreadStart(CreateAndShowTemperature));
         thrdTemperature.Start();
      }

      private void cmdPrecip_Click(object sender, System.EventArgs e)
      {
         Thread thrdPrecipitation;
         thrdPrecipitation = 
            new Thread(new ThreadStart(CreateAndShowPrecipitation));
         thrdPrecipitation.Start();
      }
      ...
      private void cmdPress_Click(object sender, System.EventArgs e)
      {
         Thread thrdPressure;
         thrdPressure = 
            new Thread(new ThreadStart(CreateAndShowPressure));
         thrdPressure.Start();
      }
      ...
      // Thread routines for displaying forms.
      private void CreateAndShowTemperature()
      {
         Global.OpenForm(Type.GetType
            ("MultiThreaded.FormTemperature")).ShowDialog();
      }
      private void CreateAndShowPressure()
      {
         Global.OpenForm(Type.GetType
            ("MultiThreaded.FormPressure")).ShowDialog();
      }
      private void CreateAndShowPrecipitation()
      {
         Global.OpenForm(Type.GetType
            ("MultiThreaded.FormPrecipitation")).ShowDialog();
      }
   }
}
